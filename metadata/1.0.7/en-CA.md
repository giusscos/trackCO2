...
Log the activities that matter: driving, flying, public transit, food choices, home energy, walking, biking, tree planting, and recycling. See your real CO₂ consumption and compensation build up over the week with clear charts and summaries.
...
1. **Hero** — Claud mascot healthy (mint/green), weekly CO₂ chart populated, weather widget visible.
2. **Activities** — Mixed activity list with transport and food items, recent log entries.
3. **Trips** — Map with route; transit/walk/car comparison cards, greenest option first.
4. **Tips** — Smart tip with real CO₂ numbers and actionable advice.
5. **Weather** — Positive walking suggestion on a clear day.

Capture on **iPhone 16 Pro Max** (1290×2796) with **English (Canada)** system language.
